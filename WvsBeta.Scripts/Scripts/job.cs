...
namespace WvsBeta.Scripts.Scripts
{
    public static class job
    {
        ...
        {
            dynamic v2, nPSP, val, incval, v1, qr, v, cJob, inventory, mJob, nSec, nRet, Adv, ret;
            public void Run(INpcHost self, GameCharacter target)
            {
                ...
                if (val == "s" && (cJob == 110 || cJob == 120 || cJob == 130))
                {
                    qr.Set(7500, "p1");
                            ...
                            else if (inventory.ItemCount(4031012) >= 1)
                            {
                                ...
                                else if (v1 == 3)
                                {
                                    ...
                                    if (v2 == 0)
                                    {
                                        ...
                                        {
                                            nPSP = (target.Level - 30) * 3;
                                            if (target.SP > nPSP) self.Say("Hummm... você tem #bSP#k demais... você não pode subir para o 2º nívelde classe com tanto SP guardado. Use mais SP nas habilidades do 1º nível e volte mais tarde.");
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    target.Job = 110;
                                                    target.IncSP(1, 0);
                                                    incval = Rand32.NextBetween(300, 350);
                                    ...
                                    else if (v2 == 1)
                                    {
                                        ...
                                        {
                                            nPSP = (target.Level - 30) * 3;
                                            if (target.SP > nPSP) self.Say("Hummm, acho que você tem #bSP#k demais. Você não pode subir para o 2º nível de classe com tanto SP guardado. Use mais SP nas habilidades do 1º nível e volte mais tarde.");
                                            else
                                            {
                                                ret = inventory.Exchange(0, 4031012, -1);
                                                ...
                                                else
                                                {
                                                    target.Job = 120;
                                                    target.IncSP(1, 0);
                                                    incval = Rand32.NextBetween(100, 150);
                                    ...
                                    else if (v2 == 2)
                                    {
                                        ...
                                        {
                                            nPSP = (target.Level - 30) * 3;
                                            if (target.SP > nPSP) self.Say("Hummm... você tem #bSP#k demais... você não pode subir para o 2º nível de classe com tanto SP guardado. Use mais SP nas habilidades do 1º nível e volte mais tarde.");
                                            else
                                            {
                                                ret = inventory.Exchange(0, 4031012, -1);
                    ...
                    else if (target.Job == 0)
                    {
                        ...
                        if (target.Level > 9 && target.STR > 34)
                        {
                            ...
                            else if (nRet == 1)
                            {
                                ...
                                target.Job = 100;
                                incval = Rand32.NextBetween(200, 250);
                                target.IncMHP(incval, 0);
                                target.IncSP(1, 0);
        ...
        {
            dynamic v2, nPSP, val, incval, v1, inven, qr, v, cJob, inventory, mJob, nSec, nRet, ret;
            public void Run(INpcHost self, GameCharacter target)
            {
                job.self = self;
                job.target = target;
                ...
                if (val == "s" && (cJob == 210 || cJob == 220 || cJob == 230))
                {
                    qr.Set(7500, "p1");
                ...
                else
                {
                            ...
                            else if (inventory.ItemCount(4031012) >= 1)
                            {
                                ...
                                else if (v1 == 3)
                                {
                                        ...
                                        else if (mJob == 1)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    target.Job = 210;
                                                    target.IncSP(1, 0);
                                                    incval = Rand32.NextBetween(450, 500);
                                                    target.IncMMP(incval, 0);
                                                    inventory.IncSlotCount(4, 4);
                                    ...
                                    else if (v2 == 2)
                                    {
                                        ...
                                        {
                                            nPSP = (target.Level - 30) * 3;
                                            if (target.SP > nPSP) self.Say("Hummm... você tem #bSP#k demais. Você não poderá subir para o 2º nível de classe com tanto SP guardado. Use mais SP nas habilidades do 1º nível e volte mais tarde...");
                                            else
                                            {
                                                ret = inventory.Exchange(0, 4031012, -1);
                    ...
                    else if (target.Job == 210) self.Say("Ahhh... é você... o que você acha da vida como Feiticeiro? Você... parece bem à vontade com essas flechas em chamas agora... por favor, dedique-se e treine ainda mais.");
                    else if (target.Job == 220) self.Say("Ahhh... é você... o que você acha da vida como Feiticeiro? Você... parece ser capaz de lidar com o gelo e o luz com facilidade... por favor, dedique-se e treine ainda mais.");
                    else if (target.Job == 230) self.Say("Ahhh... é você... o que você acha da vida como Clérigo? Você... parece ser capaz de lidar com magia sagrada com facilidade... por favor, dedique-se e treine ainda mais.");
                    else if (target.Job == 211 || target.Job == 221) self.Say("Ahhh... Você finalmente se tornou um #bMago#k... Eu sabia que você não iria me decepcionar. Então, o que você acha da vida como Mago? Por favor, dedique-se e treine ainda mais.");
                    else if (target.Job == 231) self.Say("Ahhh... Você finalmente se tornou um #bSacerdote#k... Eu sabia que você não iria me decepcionar. Então, o que você acha da vida como Sacerdote? Por favor, dedique-se e treine ainda mais.");
