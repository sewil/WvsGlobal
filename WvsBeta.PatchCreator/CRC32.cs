...
namespace WvsBeta.PatchCreator
{
    ...
    {
        // Thanks to Fiel for this function
        public static uint CalculateChecksum(byte[] eachBlock, long lengthOfBlock, uint rollingChecksum)
        {
            uint IndexLookup;
            uint blockPos;
        ...
        static readonly uint[] sbox = new uint[256]{
